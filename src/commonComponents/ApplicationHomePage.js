...
class DesktopContainer extends Component {
  ...
  routeToAuthentication = () => CreateBrowserHistory.push({ pathname: "/authorization" })
  render() {
            ...
            >
              <Container>
                ...
                <Menu.Item position='right'>
                  <Button as='a' inverted={!fixed} onClick={this.routeToAuthentication}>Login/Signup</Button>
                </Menu.Item>
              </Container>
            </Menu>
            <HomepageHeading />
